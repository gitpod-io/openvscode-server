...
configurationRegistry.registerConfiguration({
	...
	properties: {
		...
		'chat.claude.baseUrl': {
			...
			markdownDescription: nls.localize('chat.claude.baseUrl', "Base URL for Claude API. Default is the official Anthropic API endpoint."),
			scope: ConfigurationScope.APPLICATION,
			tags: ['experimental']
		},
		[mcpEnabledSection]: {
...
// Register browser default chat agent for web environments
import './browserDefaultChatAgent.contribution.js';
